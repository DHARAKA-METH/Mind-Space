...
Use Spotify app search links only.

Example:
spotify:search:lofi%20study
...
- Meditation: guided meditation, mindfulness, or breathing.
- Music: calm or soft instrumental music.
- Activity: Based on the student's current situation, suggest a suitable gentle activity such as walking, stretching, yoga, or outdoor time; avoid intense activities.
...
spotify:search:calm%20piano

spotify:search:stress%20relief%20music
  ...
  try {
    ...
    return {
      ...
      recommendations: [
        {
          category: "music",
          title: "Focus & Positive Music",
          description:
            "Light focus music can help maintain a positive mood and support studying or daily activities.",
          link: "spotify:search:focus%20positive%20music",
          stressRange: "Low",
        },
        {
          category: "activity",
          ...
          description:
            "A short stretching or movement break can help refresh your mind and maintain energy during study.",
          link: "https://www.youtube.com/results?search_query=5+minute+study+break+stretching",
          stressRange: "Low",
        },
        {
          category: "activity",
          title: "10 Minute Relaxing Walk",
          description:
            "A short walk can help refresh the mind, maintain a positive mood, and provide a healthy break from studying.",
          link: "https://www.youtube.com/results?search_query=10+minute+relaxing+walk",
          stressRange: "Low",
        }
      ],
    };
